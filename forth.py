...
peforth.dictate(
    r'''
	\ DataRobot 專用 --------------------------------------------------------------------------------------------
		char https://app.datarobot.com/api/v2 constant endpoint // ( -- str ) DataRobot endpoint 
		char NjBiNzQzMzA3NWVkNjdhNjhjM2M4Y2RkOkZSS0RTL1lYaUE1WWRZbU5Ka1gwb1YvM3lHTmc3ZVByeXErUGo0SmZpOHc9 constant api_token // ( -- str ) DataRobot api_token 
	\ paste command ---------------------------------------------------------------------------------------------
		' paste [if] 
			.( 煩不煩？已經執行過了！ ) cr stop 
		[else]
